    ...
    <div className="flex-1 h-full overflow-auto py-2">
      <nav className="grid items-start px-4 gap-y-6 text-sm font-normal">
        <Link
          ...
          href="/dashboard/medecin" className=" flex items-center gap-3 rounded-lg px-3 py-2  transition-all hover:text-gray-900"
        >
        ...
        <Link
          ...
          href="/dashboard/medecin/add_aux" className= "flex items-center gap-3 rounded-lg px-3 py-2  transition-all hover:text-gray-900"
        >
