      ...
      <div className="flex-1 h-full overflow-auto py-2">
        <nav className="grid items-start px-4 gap-y-6 text-sm font-normal">
          <Link
            ...
            className={`link ${
              pathname === "/dashboard/medecin" ? "text-white bg-[#079a31]" : ""
          ...
          <Link
            href="/dashboard/admin/auxiliaire"
            className={`link ${
              pathname === "/dashboard/medecin/add_aux"
                ? "text-white bg-[#079a31]"
                : ""
            } flex items-center gap-3 rounded-lg px-3 py-2  transition-all hover:text-gray-900`}
          >
